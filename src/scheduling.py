...
def run_reuse_gated(self, graph):
    """
...
def run_reuse_total(self, graph):
    """
...
Scheduling.run_reuse_gated = run_reuse_gated
Scheduling.run_reuse_total = run_reuse_total
Scheduling.parse_2_generate = parse_2_generate
